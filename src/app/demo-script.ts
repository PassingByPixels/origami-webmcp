...
/* "33" is the registered tool count this page reports (tests/e2e/app.spec.ts asserts it). It is
...
const COVER = `<div class="slide-inner">
  ...
  <div class="card-grid">
    <div class="stat-card"><div class="big">33</div><div class="lbl">Tools on the page</div></div>
