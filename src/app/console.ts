...
export const FOLIO_GROUPS: ToolGroups = [
  ...
  ['Author', ['create_deck', 'add_fold', 'add_ledger', 'add_chunk', 'add_custom_fold', 'write_chunk', 'set_block', 'load_image', 'move_chunk', 'set_chunk_meta', 'delete_chunk', 'define_block', 'delete_block', 'set_header', 'set_deck_meta', 'apply_theme', 'save_theme', 'delete_theme', 'set_fold_type', 'undo', 'revert_to_saved']],
