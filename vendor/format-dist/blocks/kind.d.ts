...
export type Kind = 'cover' | 'bullets' | 'stats' | 'free' | 'document' | 'gantt' | 'flow' | 'graph' | 'chart' | 'video' | 'tracker' | 'notes' | 'grid' | 'table' | 'block' | 'slider' | 'draw' | 'venn' | 'calendar' | 'gallery' | 'timeline';
